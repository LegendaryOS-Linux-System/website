window.LEGENDARY_RELEASES = [
  {
    ...
    date: "2026-06-09",
    status: "stable",
    summary: "LegendaryOS — Nowoczesna, niezmutowalna dystrybucja Linux. Zbudowana na Fedorze i mechanizmie bootc/ostree. Zaktualizowano obraz OCI i narzędzia oraz drobne poprawki.",
    changes: [
      {
        category: "System",
        items: [
          "Rozbudowane narzędzia CLI",
          "Dodano aplikację LegendaryOS App",
          "Trwają prace nad edycją LegendaryOS Blue",
          "Trwają prace nad własnym customowym jądrem dla LegendaryOS (LegendaryOS Kernel)"
        ]
      },
      {
        category: "Narzędzia",
        items: [
          "Nowy rejestr obrazów: ghcr.io/legendaryos-linux-system/legendaryos:stable-kde",
          "W przyszłości (Blue): ghcr.io/legendaryos-linux-system/legendaryos:stable-blue"
        ]
      },
      {
